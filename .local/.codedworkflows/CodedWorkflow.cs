...
namespace uipathwithvansah
{
    ...
    {
        private Lazy<uipathwithvansah.WorkflowRunnerService> _workflowRunnerServiceLazy;
        ...
        public CodedWorkflow()
        {
            ...
            _workflowRunnerServiceLazy = new Lazy<uipathwithvansah.WorkflowRunnerService>(() => new uipathwithvansah.WorkflowRunnerService(this.services));
#pragma warning disable
            _connectionsManagerLazy = new Lazy<ConnectionsManager>(() => new ConnectionsManager(serviceContainer));
#pragma warning restore
        }

        protected uipathwithvansah.WorkflowRunnerService workflows => _workflowRunnerServiceLazy.Value;
